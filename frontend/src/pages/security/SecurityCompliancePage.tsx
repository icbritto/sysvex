...
const ACTION_LABELS: Record<string, string> = {
  ...
  BOM_RECIPE_CREATED: 'Receita criada',
  BOM_RECIPE_RENAMED: 'Receita renomeada',
  BOM_RECIPE_SET_DEFAULT: 'Receita definida como padrão',
  BOM_RECIPE_DELETED: 'Receita excluída',
  ...
  SALES_ORDER_UPDATED: 'Pedido de venda editado',
  SALES_ORDER_CONFIRMED: 'Pedido de venda confirmado',
  SALES_ORDER_CANCELLED: 'Pedido de venda cancelado',
  SALES_ORDER_SHIPPED: 'Pedido de venda marcado como enviado',
  SALES_ORDER_DELIVERED: 'Pedido de venda marcado como entregue',
